...
<div class="section" id="user-section">
    <div id="user-detail">
        ...
        <div id="user-info">
            <h2 id="user-name">Yoga Pamungkas</h2>
                    ...
                    <div class="card-body">
                        <div class="presencecontent">
                            ...
                            <div class="presencedetail">
                                ...
                                <span>{{$presensihariini != null ? $presensihariini->jam_in :'Belum Absent'}}</span>
                    ...
                    <div class="card-body">
                        <div class="presencecontent">
                            ...
                            <div class="presencedetail">
                                ...
                                <span>{{$presensihariini != null && $presensihariini->jam_out != null ? $presensihariini->jam_out :'Belum Absent'}}</span>
                            </div>
                        </div>
                    </div>
                </div>
